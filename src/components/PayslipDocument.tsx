    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          <View>
            ...
            {data.organization.pan_number ? (
              <Text style={styles.small}>PAN: {data.organization.pan_number}</Text>
            ) : null}
          </View>
          <View style={{ alignItems: "flex-end" }}>
            ...
            <Text style={styles.small}>
              {fmt(data.cycle.cycle_start)} – {fmt(data.cycle.cycle_end)}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.empBox}>
          <View style={styles.col}>
            <View style={styles.row}>
              ...
              <Text style={styles.value}>{data.employee.full_name}</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.label}>Emp Code</Text>
              <Text style={styles.value}>{data.employee.employee_code}</Text>
            </View>
            <View style={styles.row}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.value}>{data.employee.designation || "—"}</Text>
            </View>
            {data.employee.joining_date ? (
              <View style={styles.row}>
                <Text style={styles.label}>Joined</Text>
                <Text style={styles.value}>{fmt(data.employee.joining_date)}</Text>
              </View>
            ) : null}
          </View>
          ...
          <View style={styles.col}>
            <View style={styles.row}>
              ...
              <Text style={styles.value}>{data.employee.pan_number || "—"}</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.label}>UAN</Text>
              <Text style={styles.value}>{data.employee.uan_number || "—"}</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.label}>Bank</Text>
              <Text style={styles.value}>{data.employee.bank_name || "—"}</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.label}>Account</Text>
              <Text style={styles.value}>{data.employee.bank_account || "—"}</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.label}>IFSC</Text>
              <Text style={styles.value}>{data.employee.bank_ifsc || "—"}</Text>
            </View>
          </View>
          ...
          <View style={styles.col}>
            <View style={styles.row}>
              ...
              <Text style={styles.value}>{data.totals.working_days}</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.label}>Payable days</Text>
              <Text style={styles.value}>{data.totals.payable_days.toFixed(2)}</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.label}>Present</Text>
              <Text style={styles.value}>{data.totals.present_days.toFixed(1)}</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.label}>Paid leave</Text>
              <Text style={styles.value}>{data.totals.paid_leave_days.toFixed(1)}</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.label}>LOP</Text>
              <Text style={styles.value}>{data.totals.lop_days.toFixed(1)}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.twoCol}>
          <View style={[styles.table, styles.half]}>
            <View style={styles.trH}>
              <Text style={styles.td1}>Earnings</Text>
              <Text style={styles.td2}>Amount</Text>
            </View>
            {data.earnings.map((e) => (
              <View style={styles.tr} key={e.code}>
                <Text style={styles.td1}>{e.name}</Text>
                <Text style={styles.td2}>{inr(e.amount)}</Text>
              </View>
            ))}
            <View style={styles.totalRow}>
              <Text style={styles.td1}>Gross Earnings</Text>
              <Text style={styles.td2}>{inr(data.gross)}</Text>
            </View>
          </View>

          <View style={[styles.table, styles.half]}>
            <View style={styles.trH}>
              <Text style={styles.td1}>Deductions</Text>
              <Text style={styles.td2}>Amount</Text>
            </View>
            ...
            <View style={styles.totalRow}>
              <Text style={styles.td1}>Total Deductions</Text>
              <Text style={styles.td2}>{inr(data.total_deductions)}</Text>
            </View>
          </View>
        </View>
        ...
        <Text style={styles.footer}>
          This is a system-generated payslip and does not require signature. Generated on{" "}
